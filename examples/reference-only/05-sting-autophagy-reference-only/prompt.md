...
- 画布：2100×1324 px
- 参考图 SHA-256：`ef0e94b0ee05e3af383f0b9a6f28dea40b504daa001d8ac561dc363ee3770240`
...
【硬性要求】
1. `<svg>` 根元素必须带 `width="2100" height="1324" viewBox="0 0 2100 1324"`，所有坐标以原图像素为基准，不得缩放；还必须从本案例合同逐字填写
...
4. 照片、真实场景截图、复杂写实图标，以及不含文字且无法高质量矢量还原的写实装饰元素：不要重绘，放占位矩形
   ...
   或经授权的内联矢量组 `<g id="atomic:...">`；位置尺寸与原图该区域一致。含文字/公式的内容、几何图形、线条、箭头禁止占位。
