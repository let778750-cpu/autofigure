...
from tools.arrow_spec import HEAD_TYPES, REPRESENTATIONS
...
def freeze_inventory(run: common.Run) -> dict[str, Any]:
    ...
    from tools.regions import build_critical_region_expectation
    ...
    from tools.asset_spec import freeze_asset_contract
