            ...
            manifest_assets.append(
                {
                    ...
                    "selectedFile": str(output),
                    "sourceFile": str(live_root / "input" / "reference.png"),
...
def build_powerpoint_live_bridge(run: common.Run) -> dict[str, Any]:
    ...
    manifest = {
        ...
        "case_root": str(live_root),
        "project_id": project_id,
        "target_id": TARGET_ID,
        "task_mode": "RECONSTRUCT_1TO1",
        "template_path": str(template_copy),
