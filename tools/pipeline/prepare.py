...
from tools.core.contracts import FIDELITY_PROFILES, INPUT_ROUTES, PROCESSING_MODES
...
def main(argv: list[str] | None = None) -> int:
    ...
    if seed_path is not None:
        ...
        from tools.core.contracts import record_candidate_provenance, write_json
