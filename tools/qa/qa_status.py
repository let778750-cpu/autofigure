...
from tools.core.contracts import SCHEMA_VERSION, read_json, write_json
...
def _offline_package_consistency(
    ...
    from tools.qa.qa_lineage import MANIFEST_NAME, validate_qa_lineage_manifest
...
def _repair_plan_validation(
    ...
    from tools.repair.repair_plan import validate_repair_plan
...
def _release_eligibility(
    ...
    *,
    ...
    from tools.qa.release import RELEASE_MANIFEST_NAME, validate_release_manifest
