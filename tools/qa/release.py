...
from tools.core.contracts import SCHEMA_VERSION, read_json, utc_now, write_json
...
def build_release_manifest(run: common.Run) -> dict[str, Any]:
    from tools.qa.qa_status import QA_STATUS_NAME
...
def main(argv: list[str] | None = None) -> int:
    ...
    from tools.qa.qa_status import compute_qa_dimensions
