...
from tools.pipeline.layout import Box, collect_svg_records
...
from tools.core.svggeom import Matrix
...
def _build_backend_index(run: common.Run) -> BackendIndex:
    from tools.repair.live_bridge import _shape_bounds, _walk_shapes
...
def _translated_text_backend_box(
    ...
    if len(shapes) != 1:
        return None
    from tools.repair.live_bridge import _shape_bounds
